<?php foreach ($site->languages() as $language): ?>
  <li <?php e($site->language() == $language, 'style=display:none;') ?>>
    <a href="<?php echo $language->url() ?>" class="switcher">
      <svg height="100%" stroke-linejoin="round" version="1" viewBox="0 0 166 166" width="100%" xml:space="preserve" xmlns="http://www.w3.org/2000/svg">
        <clipPath id="clip">
          <path d="M40 166c-8 0-20 0-30-10 -10-10-10-22-10-30l0-86c0-8 0-20 10-30 10-10 22-10 30-10l86 0c8 0 20 0 30 10 10 10 10 22 10 30l0 86c0 8 0 20-10 30 -10 10-22 10-30 10l-86 0Z"/>
        </clipPath>
